    ...
    public class SplitWingHandler : SolverHandlerBase
    {
        ...
        public override List<CellInfo> Elimination(QSudoku qSudoku)
        {
            ...
            foreach (var item in pairCells)
            {
                ...
                var value1 = rest[0]; //2
                var value2 = rest[1]; //7
                var filterCells = allUnsetCells.Where(c =>
                ...
                if (filterCells.Count > 3)
                {
                    ...
                    var keyCells = (from a in filterCells
                            ...
                            where indexs.Count() == 4
                                  ...
                                  && (abCells.Select(c => c.Row).Distinct().Count() == 1 ||
                                      abCells.Select(c => c.Column).Distinct().Count() == 1)
                    ...
                    foreach (var keyCell in keyCells)
                    {
                        ...
                        if (aNextCell.Exists(x => x.Index == c.Index && x.Value == value2))
                        {
                            ...
                            var dNextCell = new NegativeCell(d.Index, value1, qSudoku).NextCells;
                            if (bNextCell.Exists(x => x.Index == d.Index && x.Value == value1)
